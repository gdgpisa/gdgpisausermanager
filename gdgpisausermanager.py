...
def welcome(bot, update):
	for new_user_obj in update.message.new_chat_members:
		...
		reply_text = "Benvenut* {} in <b>{}</b>! Premi <i>Confermo</i> per dimostrare di non essere un bot.".format(new_user, update.message.chat.title)
		...
		threading.Timer(Config.WAITING_TIMEOUT, timer, [bot, new_user_obj.id, update.message.chat_id, mexid.message_id]).start()
		return
